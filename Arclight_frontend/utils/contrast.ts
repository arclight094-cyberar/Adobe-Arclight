...
/**
 * Contrast Filter
 * Converts slider value (-50 to 50) to contrast factor (0 to 2)
 * -50 = no contrast / gray (factor 0)
 * 0 = original (factor 1)
 * 50 = high contrast (factor 2)
 */

/**
 * Calculate contrast factor from slider value
 * @param value - Slider value from -50 to 50
 * @returns Contrast factor from 0 to 2
 */
export const calculateContrastFactor = (value: number): number => {
   ...
   * @param value - Contrast value from -50 to 50
