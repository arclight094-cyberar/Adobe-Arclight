...
export default function Workspace() {
  ...
  const handleSubjectRemoval = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Removal Failed',
        error.message || 'Failed to remove subject. Please try again.',
        [{ text: 'OK' }]
      );
    } finally {
      setIsEnhancing(false);
  ...
  const handleStyleTransfer = async () => {
    Alert.alert(
      'Style Transfer',
      'Style transfer requires selecting a style image. This feature will be available soon.',
      [{ text: 'OK' }]
    );
  };
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      {isEnhancing && (
        <View style={styles.enhanceOverlay}>
          ...
          <Text style={styles.enhanceSubtext}>
