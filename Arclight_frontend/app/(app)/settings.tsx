...
export default function Settings() {
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert('Error', error.message || 'Failed to reset API URL');
            }
          },
        },
      ]
  ...
  const handleTestConnection = async () => {
    if (!apiUrl.trim()) {
      Alert.alert('Error', 'Please enter a valid API URL first');
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        Alert.alert('Warning', 'Backend responded but may not be configured correctly.');
      }
    } catch (error: any) {
      Alert.alert(
        'Connection Failed',
