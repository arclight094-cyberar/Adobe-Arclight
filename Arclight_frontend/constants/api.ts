...
const DEFAULT_DEVELOPMENT_API_URL = 'http://10.0.2.2:4000/api/v1/adobe-ps'; // Android Emulator default
const PRODUCTION_API_URL = 'https://your-domain.com/api/v1/adobe-ps';
const ANDROID_EMULATOR_API_URL = 'http://10.0.2.2:4000/api/v1/adobe-ps';
